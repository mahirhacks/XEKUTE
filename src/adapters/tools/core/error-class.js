...
function classifyErrorCode(code) {
  ...
  if (/AUTHORIZED|PERMISSION|DENIED|FORBIDDEN|NOT_ALLOWED|NOT_GRANTED|RESOURCE_NOT_ALLOWED|TYPED_.*_REQUIRED|NOT_OWNED|APPROVAL|SCOPE_OUT|TARGET_OUT_OF_SCOPE|MODE_GUARD|POLICY_BLOCK/.test(value)) return "not_authorized";
