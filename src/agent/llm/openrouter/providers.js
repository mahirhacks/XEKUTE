...
function buildChatRequest({ baseUrl = DEFAULT_OPENROUTER_BASE_URL, apiKey, model, messages = [], tools = [], stream = true, temperature, responseFormat, maxCompletionTokens, reasoningEffort, plugins, provider } = {}) {
...
module.exports = { DEFAULT_OPENROUTER_BASE_URL, normalizeProvider, normalizeBaseUrl, normalizeReasoningEffort, buildChatRequest };
