...
module.exports = { CLAIM_STATES, HYPOTHESIS_STATES, COVERAGE_STATES, VERDICTS, envelope, claimRecord, hypothesisRecord, observationRecord, verificationVerdict, findingCandidate, coverageUpdate };
