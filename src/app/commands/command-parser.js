...
const DEFAULT_COMMANDS = Object.freeze({
  ...
  "/pentest": { role: "ai", aim: "Find and validate security weaknesses within the configured assessment scope.", description: "AI-guided penetration testing that stays evidence-led and scope-aware.", prompt: "Run a scope-aware, hypothesis-driven penetration-test workflow using the Map and assessment evidence." },
...
async function runCommand(raw, assessment, overrides = null) {
  ...
  const reconMode = parsed.command === "/passive" ? "passive" : null;
