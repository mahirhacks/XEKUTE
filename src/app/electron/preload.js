...
const api = {
  ...
  loadChatHistory: (payload) => ipcRenderer.invoke("chat-history:load", payload),
  beginChatBlock: (payload) => ipcRenderer.invoke("chat-history:begin", payload),
  recordChatEvent: (payload) => ipcRenderer.invoke("chat-history:event", payload),
  updateChatSession: (payload) => ipcRenderer.invoke("chat-history:update", payload),
  closeChatSession: (payload) => ipcRenderer.invoke("chat-history:close", payload),
  reopenChatSession: (payload) => ipcRenderer.invoke("chat-history:reopen", payload),
  archiveChatSession: (payload) => ipcRenderer.invoke("chat-history:archive", payload),
  unarchiveChatSession: (payload) => ipcRenderer.invoke("chat-history:unarchive", payload),
  flushChatHistory: () => ipcRenderer.invoke("chat-history:flush"),
  saveChatHistoryBeforeClose: (payload) => ipcRenderer.sendSync("chat-history:save-before-close", payload),
  deleteChatSession: (payload) => ipcRenderer.invoke("chat-history:delete", payload),
  ...
  assessmentTrafficRecords: (payload) => ipcRenderer.invoke("assessment:trafficRecords", payload),
  ...
  proxyBrowserStatus: (payload = {}) => ipcRenderer.invoke("proxy:browserStatus", payload),
    ...
    knowledgeStatus: (payload) => ipcRenderer.invoke("knowledge:status", payload),
    knowledgePreview: (payload) => ipcRenderer.invoke("knowledge:preview", payload),
    knowledgeInstall: (payload) => ipcRenderer.invoke("knowledge:install", payload),
    knowledgeRemove: (payload) => ipcRenderer.invoke("knowledge:remove", payload),
    knowledgeReindex: (payload) => ipcRenderer.invoke("knowledge:reindex", payload),
