...
const api = {
  ...
  operationalContextStatus: (payload = {}) => ipcRenderer.invoke("context:operationalStatus", payload),
  operationalContextRead: (payload = {}) => ipcRenderer.invoke("context:operationalRead", payload),
  checkpointOperationalContext: (payload = {}) => ipcRenderer.invoke("context:operationalCheckpoint", payload),
  mergeOperationalContextLate: (payload = {}) => ipcRenderer.invoke("context:operationalMergeLate", payload),
  memoryStatus: (payload = {}) => ipcRenderer.invoke("memory:status", payload),
  memoryDiagnostics: (payload = {}) => ipcRenderer.invoke("memory:diagnostics", payload),
  memoryProjectQuery: (payload = {}) => ipcRenderer.invoke("memory:projectQuery", payload),
  memoryInvestigationQuery: (payload = {}) => ipcRenderer.invoke("memory:investigationQuery", payload),
  memoryEvidenceQuery: (payload = {}) => ipcRenderer.invoke("memory:evidenceQuery", payload),
  memoryGraphQuery: (payload = {}) => ipcRenderer.invoke("memory:graphQuery", payload),
  memoryArtifactList: (payload = {}) => ipcRenderer.invoke("memory:artifactList", payload),
  memoryArtifactExpand: (payload = {}) => ipcRenderer.invoke("memory:artifactExpand", payload),
  memoryCheckpoint: (payload = {}) => ipcRenderer.invoke("memory:checkpoint", payload),
  memoryCheckpointView: (payload = {}) => ipcRenderer.invoke("memory:checkpointView", payload),
  memoryFinalizationHealth: (payload = {}) => ipcRenderer.invoke("memory:finalizationHealth", payload),
  memoryFinalizationStatus: (payload = {}) => ipcRenderer.invoke("memory:finalizationStatus", payload),
  memoryMigrationPreview: (payload = {}) => ipcRenderer.invoke("memory:migrationPreview", payload),
  memoryOperatorMutation: (payload = {}) => ipcRenderer.invoke("memory:operatorMutation", payload),
  memorySecurityAudit: (payload = {}) => ipcRenderer.invoke("memory:securityAudit", payload),
  memoryMaintenanceStatus: (payload = {}) => ipcRenderer.invoke("memory:maintenanceStatus", payload),
  memoryMaintenanceBenchmark: (payload = {}) => ipcRenderer.invoke("memory:maintenanceBenchmark", payload),
