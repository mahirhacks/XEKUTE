...
const TerminalManager = (() => {
  ...
  function updateEmptyState() {
    ...
    tabsList.hidden = sessions.size <= 2;
    tabsList.classList.toggle("visible", sessions.size > 2);
  ...
  async function createTerminal({ profileId = "", groupId = "" } = {}) {
  ...
  async function attachAgentSession({ id, command = "", toolName = "run_command" } = {}) {
    ...
    term.writeln("\x1b[36m\x1b[1m● XEKUTE AI Agent\x1b[0m \x1b[90mrunning command in this terminal\x1b[0m");
