...
const PromptCompiler = require("../src/agent/prompt-compiler");
const AgentRuntime = require("../src/agent/agent-runtime");
const ScopeEngine = require("../src/agent/scope-engine");
const FindingGate = require("../src/agent/finding-gate");
const Verifier = require("../src/agent/verifier");
const Adapters = require("../src/tools/security-tool-adapters");
const Records = require("../src/agent/records");
const { evaluateAction, evaluateStopConditions } = require("../src/agent/policy-engine");
const { normalizeProfile } = require("../src/agent/operating-modes");
const { buildSystemContext, buildUntrustedContext } = require("../src/agent/agent-prompt");
const { isProtectedAssessmentPath } = require("../src/agent/agent-controller");
