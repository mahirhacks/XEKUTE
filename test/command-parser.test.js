...
function runPython(action, payload) {
  ...
  const result = spawnSync(executable, [path.join(__dirname, "..", "src", "automation", "commands", "command_parser.py"), "--action", action, "--payload", JSON.stringify(payload)], { encoding: "utf8" });
