...
const { createWebCloneService, extractReferences, safeRelativePath } = require("../src/harness/cyber/webclone");
...
test("WebClone preview uses a dedicated no-preload view and a loopback-only document server", () => {
  const main = fs.readFileSync(require.resolve("../src/app/main.js"), "utf8");
